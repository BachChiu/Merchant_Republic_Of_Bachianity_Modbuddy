...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="C:\Users\Bach\Downloads\Random dds\Actual needed\LEADER_BC_BACH_BACKGROUND.png"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>1266738548</m_ExportedTime>
	<m_ClassName text="UserInterface"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="LEADER_BC_BACH_BACKGROUND.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="LEADER_BC_BACH_BACKGROUND"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
