...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="C:\Users\Bach\Downloads\Random dds\Actual needed\LEADER_BC_BACH_NEUTRAL.png"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>1622123686</m_ExportedTime>
	<m_ClassName text="UserInterface"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="LEADER_BC_BACH_NEUTRAL.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="LEADER_BC_BACH_NEUTRAL"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
