...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="C:\Users\Bach\Downloads\Random dds\Actual needed\MerchantTownHistoricMoment.png"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>1883542139</m_ExportedTime>
	<m_ClassName text="UserInterface"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="MerchantTownHistoricMoment.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="MerchantTownHistoricMoment"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
